    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          <div>
            <label className="block text-sm font-medium">Student ID / Email / Phone</label>
            <input
              type="text"
              className="mt-1 w-full border rounded-lg px-4 py-2"
              placeholder="Type your student id, email or phone"
              value={loginId}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="mt-1 w-full border rounded-lg px-4 py-2 pr-20"
                value={password}
        ...
        <div className="text-center mt-4 text-sm">
          <Link href="/forgot-password" className="text-purple-600">Forgot Password?</Link>
        </div>
      </div>
    </div>
  );
